...
const at::Tensor & energies, const at::Tensor & states) {
    ...
    // nac
    at::Tensor nac_c00 = tchem::LA::UT_sy_U(dHd_c00, states),
               nac_c01 = tchem::LA::UT_sy_U(dHd_c01, states),
               nac_c11 = tchem::LA::UT_sy_U(dHd_c11, states);
    nac_c00[0][1] /= energies[1] - energies[0];
    nac_c01[0][1] /= energies[1] - energies[0];
    nac_c11[0][1] /= energies[1] - energies[0];
    // Combine to d / dc * Ha
    at::Tensor dHa_dc00 = tchem::LA::UT_sy_U(dHd_c00, states)
                        + commutor(energies.diag(), nac_c00),
               dHa_dc01 = tchem::LA::UT_sy_U(dHd_c01, states)
                        + commutor(energies.diag(), nac_c01),
               dHa_dc11 = tchem::LA::UT_sy_U(dHd_c11, states)
